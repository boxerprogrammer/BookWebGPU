...
async function main(){
    ...
    const baseShaderModule = dev.createShaderModule({
        ...
        code : `
                    ...
                    @vertex
                    fn vertexMain(@location(0) pos : vec4f,@location(1) norm : vec3f) -> VertexOutput{
                        var out : VertexOutput;
                        out.pos = cbuff.mat*pos;
                        //var mat : mat4x4f= cbuff.world;
                        //mat[3][0]=0.0;//
                        //mat[3][1]=0.0;
                        //mat[3][2]=0.0;
                    ...
                    fn fragmentMain(in:VertexOutput) -> @location(0) vec4f{
                        ...
                        let b :f32 = saturate(dot(normalize(-light),in.norm));
                        return vec4f(b,b,b,1);
                        //return vec4f(in.norm.xyz,1);
                    }
                `//シェーダコード文字列
    });
    ...
    function updateFrame(){
        ...
        pass.setVertexBuffer(1,vertexBuffer,normOffset,offset-normOffset);
